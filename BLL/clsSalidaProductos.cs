...
namespace BLL
{
    public class clsSalidaProductos
    {
        ...
        public bool ActualizarSalidaProducto(int idSalida, DateTime fechaSalida, string codigoProducto, string nombreProducto, int unidad, string detalle, bool estadoSalidaProducto)
        {
            try
            {
                int respuesta = 1;
