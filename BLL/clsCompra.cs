...
namespace BLL
{
    public class clsCompra
    {
        ...
        public bool AgregarCompra(int idColaborador, string nombreProducto, int cantidadCompra, string detalleCompra, bool estadoCompra)
        {
            try
            {
                int respuesta = 1;
                DatosDataContext dc = new DatosDataContext();
                respuesta = Convert.ToInt32(dc.AgregarCompra(idColaborador, nombreProducto, cantidadCompra, detalleCompra, estadoCompra));
